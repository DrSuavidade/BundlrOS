...
import { User as UserIcon, Lock, Mail, Building, Clock } from 'lucide-react';
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-8 animate-fade-in">
      <header>
        ...
        <p className="text-zinc-400">Manage your personal information and security settings.</p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
            <GlassCard>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                     ...
                     <div className="space-y-1">
                         <label className="text-xs font-semibold text-zinc-500 uppercase">Organization</label>
                         <div className="flex items-center gap-2 text-zinc-300 bg-surface/50 p-2 rounded-lg border border-white/5">
                            <Building size={14} />
                     ...
                     <div className="space-y-1">
                         <label className="text-xs font-semibold text-zinc-500 uppercase">Joined On</label>
                         <div className="flex items-center gap-2 text-zinc-300 bg-surface/50 p-2 rounded-lg border border-white/5">
                            <Clock size={14} />
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 bg-white/5 rounded-lg border border-white/5">
                        ...
                        <div className="flex items-center gap-2">
                            <span className="text-xs text-zinc-500 bg-zinc-800 px-2 py-0.5 rounded">Disabled</span>
        ...
        <div className="space-y-6">
             <GlassCard className="bg-gradient-to-br from-blue-900/20 to-purple-900/20 border-blue-500/10">
                 <h3 className="text-sm font-bold text-blue-200 mb-2 uppercase tracking-wide">Access Level</h3>
                 <p className="text-sm text-blue-200/70 mb-4">
                     Your role is <strong>{user.role}</strong>. This grants you permissions to:
                 </p>
